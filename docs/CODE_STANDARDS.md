...
This document outlines the coding standards, best practices, and conventions used in the meowdoku_helper Flutter-Rust FFI project. These standards ensure consistency, maintainability, and collaboration across the Flutter-Rust codebase.
...
- `lib/src/rust/api/meowdoku_helper.dart` - Auto-generated API bindings
...
flutter analyze --no-fatal-infos 2>/dev/null | grep "public_member_api_docs" | grep -v "lib/src/rust/frb_generated" | grep -v "lib/src/rust/api/meowdoku_helper"
