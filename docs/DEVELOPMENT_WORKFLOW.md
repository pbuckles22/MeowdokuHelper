...
This document outlines the comprehensive development workflow for the meowdoku_helper Flutter-Rust FFI bolt-on project, emphasizing TDD (Test-Driven Development), code quality, and proper algorithm migration from the reference implementation.
...
# Example: Add a new meowdoku_helper algorithm
