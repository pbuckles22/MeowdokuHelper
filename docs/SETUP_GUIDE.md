# Setup Guide - meowdoku_helper Flutter-Rust FFI Project

**Command**: `flutter_rust_bridge_codegen create my_working_ffi_app`

This guide documents the setup for the meowdoku_helper Flutter-Rust FFI bolt-on project.

## 🎯 Project Overview

**Goal**: Create a production-ready meowdoku_helper Flutter-Rust FFI integration with AI-powered Wordle solving capabilities.
