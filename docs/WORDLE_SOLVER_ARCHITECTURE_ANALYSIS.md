# Star Battle Solver Architecture Analysis: Answer Words vs Dictionary Access

## Executive Summary

This document analyzes the architecture of our Star Battle solver, specifically examining the debate around whether the solver should have access to answer words versus only guess words, and the implications for benchmark accuracy and real-world performance.
...
- Compare with other Star Battle solvers
