...
abstract class WordManager implements RustOpaqueInterface {
  ...
  static Future<WordManager> newInstance() =>
      RustLib.instance.api.crateApiMeowdokuHelperWordManagerNew();
}
...
class GuessResult {
  ...
  }) => RustLib.instance.api.crateApiMeowdokuHelperGuessResultNew(
    word: word,
    results: results,
  );
...
class IntelligentSolver {
  ...
  Future<double> calculateEntropy({
    ...
    required List<String> remainingWords,
      ...
      .crateApiMeowdokuHelperIntelligentSolverCalculateEntropy(
        that: this,
  ...
  }) => RustLib.instance.api.crateApiMeowdokuHelperIntelligentSolverFilterWords(
    that: this,
    words: words,
  ...
  Future<String?> getBestGuess({
    ...
    required List<GuessResult> guessResults,
      ...
      RustLib.instance.api.crateApiMeowdokuHelperIntelligentSolverGetBestGuess(
        that: this,
        remainingWords: remainingWords,
        guessResults: guessResults,
      );
  ...
  static Future<IntelligentSolver> newInstance({required List<String> words}) =>
      RustLib.instance.api.crateApiMeowdokuHelperIntelligentSolverNew(
        words: words,
      );
  ...
  Future<String> simulateGuessPattern({
    ...
    required String target,
      ...
      .crateApiMeowdokuHelperIntelligentSolverSimulateGuessPattern(
        that: this,
        guess: guess,
        target: target,
      );
  ...
  Future<bool> wordMatchesPattern({
    ...
    required GuessResult guessResult,
      ...
      .crateApiMeowdokuHelperIntelligentSolverWordMatchesPattern(
        that: this,
        word: word,
