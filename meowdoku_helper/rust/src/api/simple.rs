...
use crate::api::meowdoku_helper::{IntelligentSolver, GuessResult, LetterResult, WORD_MANAGER};
use crate::api::meowdoku_helper_reference::IntelligentSolver as ReferenceSolver;
...
fn word_matches_single_feedback(candidate: &str, guess_result: &crate::api::meowdoku_helper::GuessResult) -> bool {
    ...
    for i in 0..5 {
        match guess_result.results[i] {
            crate::api::meowdoku_helper::LetterResult::Green => {
                fixed_positions.insert(i, guess_chars[i]);
                *min_required.entry(guess_chars[i]).or_insert(0) += 1;
            }
            crate::api::meowdoku_helper::LetterResult::Yellow => {
                banned_positions.insert(i, guess_chars[i]);
                *min_required.entry(guess_chars[i]).or_insert(0) += 1;
            }
            crate::api::meowdoku_helper::LetterResult::Gray => {}
        }
    }
    ...
    for i in 0..5 {
        if let crate::api::meowdoku_helper::LetterResult::Gray = guess_result.results[i] {
...
// ============================================================================
// meowdoku_helper Intelligent Solver FFI Functions
// ============================================================================
 ...
 * 
 * This function uses the meowdoku_helper intelligent solver with Rust-managed word lists
...
pub fn get_intelligent_guess_fast(
    ...
    use crate::api::meowdoku_helper::{WORD_MANAGER, IntelligentSolver};
...
pub fn set_solver_config(
    ...
    use crate::api::meowdoku_helper::{SOLVER_CONFIG, SolverConfig};
...
mod tests {
    ...
    fn test_filter_words_basic() {
        ...
        use crate::api::meowdoku_helper::{IntelligentSolver, GuessResult, LetterResult};
    ...
    #[test]
    fn test_meowdoku_helper_integration() {
        // Test complete meowdoku_helper workflow
        let all_words = vec!["CRANE".to_string(), "SLATE".to_string(), "CRATE".to_string()];
        let remaining = vec!["CRANE".to_string(), "SLATE".to_string()];
