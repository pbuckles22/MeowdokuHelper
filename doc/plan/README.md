# Product plan — epics and stories
...
**Fixtures (Phase 2+):** [FIXTURES.md](FIXTURES.md) — screenshot levels, difficulty order.

When a story ships: check off in **EPICS_AND_STORIES**, **PM_PLAN**, and **PROJECT_STATUS**.
